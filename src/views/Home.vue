<template>
 <div class="main__home">
  ...
  <section class="main__section py-16 lg:py-20 lg:mx-16 xl:mx-38">
   <CardOverview
    :title="cardLeft.title"
    :desc="cardLeft.desc"
    :imageURL="cardLeft.imageURL"
    :button="cardLeft.button"
   />
   ...
   <CardOverview
    placement="right"
    :title="cardRight.title"
    :desc="cardRight.desc"
    :imageURL="cardRight.imageURL"
    :button="cardRight.button"
   />
  </section>
  ...
  <section class="main__section mt-28 mb-20 sm:my-24 lg:mx-16 xl:mx-38">
   <div class="contact__banner">
    <div class="contact__banner-head">
     <div class="contact__banner-title">
      Questions? We’ll put you on the right path
     </div>
    </div>
    <div class="contact__banner-body">
     <div class="contact__banner-text">
      Ask about our products, services, media sponsorships, collaboration, rate
...
.products__overview {
 ...
 &__item {
  @apply items-center w-20 sm:w-28 xl:w-36 2xl:w-40;
...
.contact {
 &__banner {
  @apply space-y-2 text-center m-auto sm:w-2/3 lg:w-1/2;
